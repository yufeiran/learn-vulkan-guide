...
VkCommandBufferAllocateInfo vkinit::command_buffer_allocate_info(VkCommandPool pool, uint32_t count , VkCommandBufferLevel level )
{
	...
	//command buffer made from our _commandpool
...
VkPipelineInputAssemblyStateCreateInfo vkinit::input_assembly_create_info(VkPrimitiveTopology topology)
{
	...
	//we are no going to use primitive restart 
...
VkPipelineRasterizationStateCreateInfo vkinit:: rasterization_state_create_info(VkPolygonMode polygonMode)
{
	...
	//turn on will discards all primitives before the rasterization stage
...
VkImageCreateInfo vkinit::image_create_info(VkFormat format, VkImageUsageFlagBits usageFlags, VkExtent3D extent)
{
...
VkImageViewCreateInfo vkinit::imageview_create_info(VkFormat format, VkImage image, VkImageAspectFlagBits aspectFlags)
{
